    ...
    <div class="container mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
            <div class="bg-white rounded-3xl shadow-2xl p-8">
                ...
                <form method="POST" action="{{ route('kontak.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="name" type="text" value="{{ old('name') }}" class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-4 focus:ring-yellow-200" placeholder="Masukkan nama lengkap" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="subject" type="text" value="{{ old('subject') }}" class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:outline-none focus:ring-4 focus:ring-yellow-200" placeholder="Subjek pesan anda" required>
                    </div>
            ...
            <div class="bg-white rounded-3xl p-6 shadow-xl card-hover">
                <h3 class="font-bold text-2xl mb-6 text-gray-800">Informasi Kontak</h3>

                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center flex-shrink-0" style="color: var(--primary);">
                        ...
                        <div>
                            <h4 class="font-bold text-lg text-gray-800">Alamat</h4>
                            <p class="text-gray-700 font-medium">Jl. Tugu Tri Angulasi Srikandang Bangsri, Kode Pos 59453</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 rounded-xl bg-green-50 flex items-center justify-center flex-shrink-0" style="color: var(--primary);">
                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.86 19.86 0 0 1 3 5.18 2 2 0 0 1 5.11 3h3a2 2 0 0 1 2 1.72c.12.86.31 1.7.57 2.5a2 2 0 0 1-.45 2.11L9.09 10.91a16 16 0 0 0 4 4l1.58-1.14a2 2 0 0 1 2.11-.45c.8.26 1.64.45 2.5.57A2 2 0 0 1 22 16.92z" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="font-bold text-lg text-gray-800">Telepon</h4>
                            <p class="text-gray-700 font-medium">0812-3456-7890</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 rounded-xl bg-yellow-50 flex items-center justify-center flex-shrink-0" style="color: var(--primary);">
                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center flex-shrink-0" style="color: var(--primary);">
                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        ...
                        <div class="flex-1">
                            <h4 class="font-bold text-lg text-gray-800">Jam Operasional</h4>
                            <div class="mt-1 space-y-1 text-sm text-gray-700 font-medium">
                                <div class="flex justify-between gap-4"><span>Senin - Kamis</span><span class="font-semibold text-gray-800">07.00 - 14.00 WIB</span></div>
                                <div class="flex justify-between gap-4"><span>Jumat</span><span class="font-semibold text-gray-800">07.00 - 11.00 WIB</span></div>
                                <div class="flex justify-between gap-4"><span>Sabtu</span><span class="font-semibold text-gray-800">07.00 - 12.30 WIB</span></div>
                                <div class="flex justify-between gap-4"><span>Minggu</span><span class="font-semibold text-gray-800">Libur</span></div>
                            </div>
                        </div>
                    </div>
                </div>
